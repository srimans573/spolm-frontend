  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, padding: 18 }}>
        <Breadcrumb items={["Personal", "Settings"]} />
        <div
          style={{
            display: "flex",
        ...
        <div
          style={{ marginTop: 20, outline: "1px solid black", padding: "10px" }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            <div>
              ...
              <p>Manage production API keys for sending log traces to Spolm</p>
            </div>
            <button
